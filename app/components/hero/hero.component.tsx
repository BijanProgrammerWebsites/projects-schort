            ...
            {authStatus === 'unauthenticated' && (
                <p className={styles['suggestion']}>
                    ...
                    >
                        ...
                        entirely. Otherwise you cannot see them after you refresh the page. You can still use and share
                        them and they will work but there is no way to see or edit them.
                    </TypewriterAnimation>{' '}
